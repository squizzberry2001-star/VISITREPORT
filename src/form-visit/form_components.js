...
Kembalikan HANYA format JSON murni TANPA markdown backtick/code block:
{
  ...
  "hasil": "..."
    ...
    const keys = [
        { provider: 'gemini', key: DEFAULT_GEMINI_API_KEY, model: 'gemini-3.6-flash' },
        { provider: 'gemini', key: atob('QVEuQWI4Uk42Sm9uY1NoQTlzNnYtREJNRWJ5dU03U2IySTRheS03cEVWaDRTQmhKck5ReVE='), model: 'gemini-3.6-flash' },
